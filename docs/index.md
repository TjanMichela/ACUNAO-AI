...
- 🔬 **Tailored for Teams**  
  Designed to meet the unique needs of interdisciplinary teams, not just the general public.

<p align="center" style="padding: 15px;">
  <a href="{{ '/installation/' | relative_url }}" style="font-size: 1.2rem; font-weight: bold; background-color: #007acc; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;">Learn More →</a>
</p>