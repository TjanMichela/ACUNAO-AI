...
class DocumentEventHandler(FileSystemEventHandler):
    ...
    def on_any_event(self, event):
        ...
        database_index = path_parts.index("ACUNAO-AI-Data")
...
class DocumentProcessor:
    ...
    Attributes:
        desktop_path: Path to the ACUNAO-AI-Data folder.
        folder_name: Name of selected folder within ACUNAO-AI-Data.
    ...
    """
    def __init__(self):
        self.desktop_path = os.path.join(os.path.expanduser("~/Documents"), "ACUNAO-AI-Data")
