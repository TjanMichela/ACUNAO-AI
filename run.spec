...
binaries = []
hiddenimports = ['chromadb', 'chromadb.utils.embedding_functions.onnx_mini_lm_l6_v2', 'chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction', "opencv-contrib-python", "cv2", "docx2pdf", "ggml-metal.metal", "llama_cpp", "timm"]
